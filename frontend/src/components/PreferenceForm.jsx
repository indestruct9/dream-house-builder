...
export default function PreferenceForm({ onGenerated, onMoodChange }) {
  ...
  return (
    <div className="p-3 bg-white rounded shadow">
      ...
      <input className="border p-1 w-full mb-2" value={mood} onChange={(e) => { setMood(e.target.value); try { if (typeof onMoodChange === 'function') onMoodChange(e.target.value); } catch(e){} }} />
