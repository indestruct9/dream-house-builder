...
<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height + 60}" viewBox="0 0 ${width} ${height + 60}">
  ...
  return (
    <div className="p-6 grid grid-cols-3 gap-6">
      <div className="col-span-1 space-y-4">
        ...
        <div className="mt-4">
          ...
          <div className="flex gap-2 mb-2">
            ...
            <button onClick={() => setTransformMode("scale")} className={`px-2 py-1 rounded ${transformMode 
            === "scale" ? "bg-blue-600 text-white" : "bg-gray-200"}`}>Scale</button>
          </div>
        ...
        <div className="mt-3 flex gap-2">
            <button onClick={() => collabRef.current.sendUndo()} className="px-3 py-1 bg-yellow-500 text-white rounded">Undo (Ctrl/Cmd+Z)</button>
            <button onClick={() => collabRef.current.sendRedo()} className="px-3 py-1 bg-yellow-500 text-white rounded">Redo (Ctrl/Cmd+Y)</button>
        </div>
        
        <div className="mt-3">
          <button onClick={() => { if (!projectId) return alert("Save project first to access versions.");
          fetchVersions(); }} className="px-3 py-1 bg-indigo-600 text-white rounded" disabled={!projectId}>
            Versions
          </button>
        </div>
        ...
        <div className="mt-3">
          ...
          <button onClick={() => collabRef.current && collabRef.current._sendPending()} className="px-2 py-1 bg-gray-200 rounded mt-2">Resend pending</button>
        </div>
        ...
        <div className="mt-4">
          <h3 className="font-semibold">Recent Ops</h3>
      ...
      <div className="col-span-1" onMouseMove={handleMouseMove} style={{ position: "relative" }}>
      ...
      <div className="col-span-1 space-y-4">
        ...
        { rooms: [] }} onSelect={(r) => handleSelectRoom(r)} />
        <div className="mt-4">
